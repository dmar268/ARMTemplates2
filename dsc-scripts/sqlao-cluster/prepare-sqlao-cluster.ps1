#requires -Version 5
Configuration PrepareAlwaysOnCluster
{
    param (
    ...
    Node localhost
    {
        ...
        xWaitForAvailabilityGroup waitforAG
        {
            ...
            DependsOn               = ("[xSQLServerEndpoint]CreateEndPoint" , "[xSQLServerAlwaysOnService]CreateAlwaysOnService")
        }

        xSQLAOGroupJoin JoinAlwaysOnGroup
        {
            Ensure                  = "Present"
            AvailabilityGroupName   = $SqlAlwaysOnAvailabilityGroupListenerName
